...
export interface AgentCapabilities {
  ...
  supportsContextExport: boolean;
    ...
    /** Agent expects the raw prompt string on stdin */

    expectsRawPromptStdin: boolean;
  ...
  export const AGENT_CAPABILITIES: Record<string, AgentCapabilities> = {
     ...
     */
      ...
      'gemini-cli': {
        ...
        requiresPromptToStart: true, // Not yet investigated

        supportsStreaming: true,     // Likely streams

        supportsResultMessages: false,

        supportsModelSelection: true, // Not yet investigated
        ...
        supportsContextExport: false, // Not yet investigated - PLACEHOLDER
                ...
                expectsSimpleJsonStdin: false, // Verified: Requires { "prompt": "..." } on stdin

                expectsRawPromptStdin: true,
